...
export const PARAM_GROUPS: ParamGroup[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: 'distribution.isoCountX', label: 'Columns', min: 1, max: 24, step: 1, value: 5, show: dist(D.ISO_GRID) },
      { key: 'distribution.isoCountZ', label: 'Rows', min: 1, max: 24, step: 1, value: 4, show: dist(D.ISO_GRID) },
      { key: 'distribution.isoSpacingX', label: 'Horizontal', min: 0.2, max: 12, step: 0.05, value: 2.4, fmt: x2, hint: 'Gap along each row.', show: dist(D.ISO_GRID) },
      { key: 'distribution.isoSpacingZ', label: 'Vertical', min: 0.2, max: 12, step: 0.05, value: 2.6, fmt: x2, hint: 'Gap between rows.', show: dist(D.ISO_GRID) },
      ...
      { key: 'distribution.spacingX', label: 'Horizontal', min: 0.1, max: 10, step: 0.01, value: 1.2, fmt: x2, show: dist(D.GRID, D.CUBE, D.DIAMOND, D.SQUARE) },
      { key: 'distribution.spacingY', label: 'Vertical', min: 0.1, max: 10, step: 0.01, value: 1.2, fmt: x2, show: dist(D.GRID, D.CUBE, D.DIAMOND, D.SQUARE) },
      { key: 'distribution.spacingZ', label: 'Depth', min: 0.1, max: 10, step: 0.01, value: 1.2, fmt: x2, show: dist(D.GRID, D.CUBE, D.DIAMOND, D.SQUARE) },
