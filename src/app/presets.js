...
export const PRESETS = [
  ...
  },
  {
    ...
    state: {
      ...
      camera: { azimuthDeg: 40, polarDeg: 52, distance: 28, targetX: 0, targetY: 4, targetZ: 0 },
    },
  },
  {
    name: 'Icon Carousel',
    state: {
      ...
      camera: { azimuthDeg: 25, polarDeg: 62, distance: 22, targetX: 0, targetY: 0, targetZ: 0 },
    },
  },
  {
    name: 'Icon Coverflow',
    state: {
      ...
      camera: { azimuthDeg: 0, polarDeg: 72, distance: 18, targetX: 0, targetY: 0, targetZ: 2 },
    },
  },
  {
    name: 'Icon Fan Deck',
    state: {
      ...
      camera: { azimuthDeg: 0, polarDeg: 78, distance: 20, targetX: 0, targetY: 0, targetZ: 0 },
    },
  },
  {
    ...
    state: {
      ...
      camera: { azimuthDeg: -28, polarDeg: 58, distance: 22, targetX: 0, targetY: 0, targetZ: 0 },
    },
  },
  {
    ...
    state: {
      ...
      camera: { azimuthDeg: 18, polarDeg: 68, distance: 24, targetX: 0, targetY: 0, targetZ: 0 },
    },
  },
  {
    name: 'Twisted Ring',
